...
public class GdxKeyRepeatSystem
{
  ...
  /**
   * Get the key repeat start delay of the specified NON-PRINTABLE key. Only keys whose character would return true for
   * {@link Character#isISOControl(char)} are allowed. The reason why is that LibGDX already repeats printable
   * characters for you automatically.
   *
   * @param gdxKeyCode
  ...
  /**
   * Set the key repeat start delay for the specified NON-PRINTABLE key. Only keys whose character would return true for
   * {@link Character#isISOControl(char)} are allowed. The reason why is that LibGDX already repeats printable
   * characters for you automatically.
   *
   * @param gdxKeyCode
  ...
  /**
   * Process any key repeats. If a repeating key is being held down, this method will ensure that it gets repeated. If a
   * repeating key is released, this method will ensure that it stops. It should be called once per frame, i.e., in
