...
public final class PlayMapSettings
{
  ...
  public static final int           ACTUAL_WIDTH                                                  = 1704;
  public static final int           ACTUAL_HEIGHT                                                 = 804;
  public static final Size2D        ACTUAL_SIZE                                                   = new Size2D (ACTUAL_WIDTH, ACTUAL_HEIGHT);
  public static final Translation2D ACTUAL_PLAY_MAP_SPACE_TO_REFERENCE_SCREEN_SPACE_TRANSLATION   = new Translation2D (14, 14);
  public static final Translation2D REFERENCE_SCREEN_SPACE_TO_ACTUAL_PLAY_MAP_SPACE_TRANSLATION   = new Translation2D (-14, -14);
