...
public final class PlayMapSettings
{
  ...
  public static final Vector2 ACTUAL_PLAY_MAP_SPACE_TO_REFERENCE_PLAY_MAP_SPACE_SCALING =
          new Vector2 (REFERENCE_WIDTH / ACTUAL_WIDTH, REFERENCE_HEIGHT / ACTUAL_HEIGHT);

  public static final Vector2 REFERENCE_PLAY_MAP_SPACE_TO_ACTUAL_PLAY_MAP_SPACE_SCALING =
          new Vector2 (ACTUAL_WIDTH / REFERENCE_WIDTH, ACTUAL_HEIGHT / REFERENCE_HEIGHT);

  public static final Vector2 COUNTRY_ARMY_CIRCLE_SIZE_ACTUAL_PLAY_MAP_SPACE =
          new Vector2 (COUNTRY_ARMY_CIRCLE_SIZE_REFERENCE_PLAY_MAP_SPACE)
                  .scl (REFERENCE_PLAY_MAP_SPACE_TO_ACTUAL_PLAY_MAP_SPACE_SCALING);
