...
public final class MultiplayerPerilGameModeMenuScreen extends InputAdapter implements Screen
{
  private final ScreenChanger screenChanger;
  private final Stage stage;
  private final InputProcessor inputProcessor;

  public MultiplayerPerilGameModeMenuScreen (final ScreenChanger screenChanger, final ScreenSize screenSize, final Skin skin)
  {
    ...
    tableL4.add (new Label ("PERIL MODE", new Label.LabelStyle (Assets.aurulentSans16, Color.WHITE))).padLeft (30)
            .top ().left ();
    tableL4.row ();
