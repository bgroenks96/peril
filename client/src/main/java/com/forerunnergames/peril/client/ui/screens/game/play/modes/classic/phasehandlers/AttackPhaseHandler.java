...
public final class AttackPhaseHandler extends AbstractBattlePhaseHandler
{
  ...
  @Nullable
  private PlayerAttackCountryRequestEvent request;
  @Nullable
  ...
  {
    super (playMap, playerBox, attackDialog, resetState, eventBus);

    countrySelectionHandler = new AttackPhaseCountrySelectionHandler ();
  }
