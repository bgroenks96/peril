...
public final class PlayerReinforceInitialCountryResponseDeniedEvent extends AbstractCountryStateChangeDeniedEvent
        implements PlayerResponseDeniedEvent <Reason>
{
  private final PlayerPacket player;

  public PlayerReinforceInitialCountryResponseDeniedEvent (final PlayerPacket player, final Reason reason)
  {
    super (reason);
  ...
  private PlayerReinforceInitialCountryResponseDeniedEvent ()
  {
    player = null;
  }
}
