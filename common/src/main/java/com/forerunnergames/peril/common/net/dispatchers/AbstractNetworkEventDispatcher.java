 ...
 * provide {@link Handler} methods for the interested events. The dispatcher will remember the original remote client
 * sender called via {@link #dispatch(Event, RemoteClient)}, and provides a mechanism to resolve the sender via
