...
public class PlayerModelTest
{
  ...
  public void testNonExistentPlayerWithIdThrowsException ()
  {
    ...
    playerModel.playerWith (new Id (UUID.fromString ("test")));
  }
  ...
  {
    final PlayerModel playerModel = createPlayerModelWithLimitOf (2);
    final Id player1Id = new Id (UUID.fromString ("1"));
    ...
    final Player player2 = new DefaultPlayer ("Test Player 2", new Id (UUID.fromString ("2")), PersonIdentity.UNKNOWN,
  ...
  {
    final PlayerModel playerModel = createPlayerModelWithLimitOf (2);
    final Id duplicateId = new Id (UUID.fromString ("1"));
  ...
  public void testRequestToRemovePlayerByIdFailedWithPlayerDoesNotExist ()
  {
    ...
    assertTrue (playerModel.requestToRemoveById (new Id (UUID.fromString ("1")))
            .failedBecauseOf (PlayerLeaveGameDeniedEvent.Reason.PLAYER_DOES_NOT_EXIST));
  }
