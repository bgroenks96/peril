...
public class PlayerModelTest
{
  ...
  public void testRequestToChangePlayerLimitByDeltaLessThanCurrentPlayerCountFailed ()
  {
    ...
    assertTrue (playerModel.requestToChangePlayerLimitBy (delta).failedBecauseOf (
                    ChangePlayerLimitDeniedEvent.REASON.CANNOT_DECREASE_BELOW_CURRENT_PLAYER_COUNT));
  ...
  public void testRequestToChangePlayerLimitByExtremeMaximumDeltaFailed ()
  {
    ...
    assertTrue (playerModel.requestToChangePlayerLimitBy (delta).failedBecauseOf (
                    ChangePlayerLimitDeniedEvent.REASON.CANNOT_INCREASE_ABOVE_MAX_PLAYERS));
    assertTrue (playerModel.playerLimitIs (oldLimit));
  }
  ...
  public void testRequestToChangePlayerLimitByExtremeMinimumDeltaFailed ()
  {
    ...
    assertTrue (playerModel.requestToChangePlayerLimitBy (delta).failedBecauseOf (
                    ChangePlayerLimitDeniedEvent.REASON.CANNOT_DECREASE_BELOW_ZERO));
    assertTrue (playerModel.playerLimitIs (oldLimit));
  }
  ...
  public void testRequestToChangePlayerLimitByZeroDeltaFailed ()
  {
    ...
    assertTrue (playerModel.requestToChangePlayerLimitBy (delta).failedBecauseOf (
                    ChangePlayerLimitDeniedEvent.REASON.REQUESTED_LIMIT_EQUALS_EXISTING_LIMIT));
    assertTrue (playerModel.playerLimitIs (oldLimit));
  }
  ...
  public void testRequestToSetPlayerLimitToBelowCurrentPlayerCountFailed ()
  {
    ...
    assertTrue (playerModel.requestToSetPlayerLimitTo (newLimit).failedBecauseOf (
                    ChangePlayerLimitDeniedEvent.REASON.CANNOT_DECREASE_BELOW_CURRENT_PLAYER_COUNT));
    assertTrue (playerModel.playerLimitIs (oldLimit));
  }
