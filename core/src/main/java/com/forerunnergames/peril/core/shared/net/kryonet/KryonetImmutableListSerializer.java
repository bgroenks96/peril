...
/**
 * Kryo {@link Serializer} for Guava's {@link ImmutableList}.
 */
public class KryonetImmutableListSerializer extends Serializer <ImmutableList <Object>>
{
  private static final boolean DOES_NOT_ACCEPT_NULL = false;
  private static final boolean IMMUTABLE = true;

  public KryonetImmutableListSerializer ()
  {
