...
public interface CountryOwnerModel
{
   ...
   */
  Result <AbstractCountryStateChangeDeniedEvent.Reason> requestToAssignCountryOwner (final Id countryId,
                                                                                     final Id ownerId);

  Result <AbstractCountryStateChangeDeniedEvent.Reason> requestToReassignCountryOwner (final Id countryId,
                                                                                       final Id newOwner);
   ...
   */
  Result <AbstractCountryStateChangeDeniedEvent.Reason> requestToUnassignCountry (final Id countryId);
